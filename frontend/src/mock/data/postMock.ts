...
export const postMock: Post[] = [
  {
    ...
    positionCount: {
      "웹 프론트엔드": { count: 1, techStack: ["React", "TypeScript"] },
      "백엔드": { count: 2, techStack: ["Spring"] },
    },
  },
  {
    id: 2,
    ...
    positionCount: {
      "웹 프론트엔드": { count: 1, techStack: ["React"] },
      "디자이너": { count: 1, techStack: ["Figma"] },
    },
  },
  {
    id: 3,
    ...
    positionCount: {
      "앱 프론트엔드": { count: 1, techStack: ["Flutter", "React Native"] },
      "백엔드": { count: 2, techStack: ["Node.js"] },
    },
  },
  {
    id: 4,
    ...
    positionCount: {
      "웹 프론트엔드": { count: 1, techStack: ["Next.js"] },
      "백엔드": { count: 1, techStack: ["Nest.js"] },
      "기획자": { count: 1, techStack: [] },
    },
  },
  {
    id: 5,
    ...
    positionCount: {
      "백엔드": { count: 3, techStack: ["Nest.js", "Python"] },
      "기획자": { count: 1, techStack: [] },
    },
  },
];